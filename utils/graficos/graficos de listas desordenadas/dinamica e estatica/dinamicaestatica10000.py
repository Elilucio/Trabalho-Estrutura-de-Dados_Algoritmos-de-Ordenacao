...
lista_dinamica = [282.78, 0.04, 0.84, 438.26, 201.76]
...
ax.set_title('Latência dos algoritmos de ordenação em listas estáticas e dinâmicas com 10.000 elementos no pior caso')
ax.set_xticks(x)
